...
class TestProjectCategoryGoal(unittest.TestCase):
    ...
    def test_get_weekday(self):
        self.assertEqual(self.time_entry.get_weekday(), "Fri")

    def test_get_pause_timedelta(self):
        self.assertEqual(self.time_entry.get_pause_timedelta(), timedelta(seconds=62))

    def test_get_duration_timedelta(self):
        self.assertEqual(
            self.time_entry.get_duration_timedelta(), timedelta(seconds=3666)
        )

    def test_get_duration_minutes(self):
        self.assertEqual(self.time_entry.get_duration_minutes(), 3666 / 60)
